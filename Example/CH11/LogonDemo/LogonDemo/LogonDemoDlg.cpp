...
// LogonDemoDlg.cpp : implementation file
//
...
CLogonDemoDlg::CLogonDemoDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_LOGONDEMO_DIALOG, pParent)
	, m_strID(_T(""))
	, m_strPassword(_T(""))
{
...
// CLogonDemoDlg message handlers
...
void CLogonDemoDlg::OnBnClickedOk()
{
	...
	CString strTmp;
	strTmp.Format(TEXT("입력한 ID는 \"%s\"이며 암호는 \"%s\"입니다."),
