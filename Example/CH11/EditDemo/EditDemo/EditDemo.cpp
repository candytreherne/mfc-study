...
BEGIN_MESSAGE_MAP(CEditDemoApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CEditDemoApp::OnAppAbout)
...
CEditDemoApp::CEditDemoApp() noexcept
{
	...
	SetAppID(_T("EditDemo.AppID.NoVersion"));
...
BOOL CEditDemoApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CEditDemoDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CEditDemoView));
	if (!pDocTemplate)
		return FALSE;
