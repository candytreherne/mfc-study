...
// SaveGrayDemoDoc.cpp : implementation of the CSaveGrayDemoDoc class
//
...
// CSaveGrayDemoDoc construction/destruction

CSaveGrayDemoDoc::CSaveGrayDemoDoc() noexcept
{
...
void CSaveGrayDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CSaveGrayDemoDoc::InitializeSearchContent()
{
...
void CSaveGrayDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
