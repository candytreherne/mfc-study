...
BEGIN_MESSAGE_MAP(CUpdaterDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON_SET_UPDATE_EVENT, &CUpdaterDlg::OnBnClickedButtonSetUpdateEvent)
END_MESSAGE_MAP()
...
void CUpdaterDlg::OnBnClickedButtonSetUpdateEvent()
{
	CEvent UpdateEvent(FALSE, TRUE, TEXT("UPDATE_TEST_EVENT"));
