...
// DrawModeDemoDoc.cpp : implementation of the CDrawModeDemoDoc class
//
...
// CDrawModeDemoDoc construction/destruction

CDrawModeDemoDoc::CDrawModeDemoDoc() noexcept
{
...
void CDrawModeDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CDrawModeDemoDoc::InitializeSearchContent()
{
...
void CDrawModeDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
